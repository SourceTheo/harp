...
🔰╜ للدخول لقناة السورس [دوس هنا](https://t.me/Source_Harp )"""
        ...
        await m.reply_text("مرحبا! أنا حرب . لاكتشاف وظائفي ، ابدأ محادثة معي.", reply_markup=keyboard)
...
async def infos(c: Client, m: CallbackQuery):
    res = """
╭──── • ◈ • ────╮
么 [᥉᥆ᥙᖇᥴᥱ حرب](t.me/Source_Harp)
么 [᥉᥆ᥙᖇᥴᥱ ხ᥆ƚ](t.me/Source_Harp )
╰──── • ◈ • ────╯
