...
async def play(client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("𖤐↜ ᥉᥆ᥙᖇᥴᥱ Harp ↝𖤐", url=f"https://t.me/SOURCE_Harp")],
            ...
            if chat.username:
                try:
                    ...
                    try:
                        ...
                        return await dream.edit(f"ساعد فشل فى الدخول الى الجروب بسبب:\n`{e}`\nفى حاله ظهور لك مثلا هذه الرساله تواصل مع المطور -> @H_A_R_P_M")
            else:
                try:
                    try:
    ...
    if admin(msg):
        ...
        if command == "/pause":
            ...
            keyboard = InlineKeyboardMarkup(inline_keyboard=[
                ...
                [InlineKeyboardButton("𖤐↜᥉᥆ᥙᖇᥴᥱ Harp ↝𖤐", url="https://t.me/SOURCE_Harp")],
